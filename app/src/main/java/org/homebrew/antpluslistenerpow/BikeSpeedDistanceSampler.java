...
public class BikeSpeedDistanceSampler {
    ...
    private static final String TAG = BikeSpeedDistanceSampler.class.getSimpleName();
...
//                                                            cadSysTimestamp = System.currentTimeMillis();
    ...
    AntPlusBikeSpdCadCommonPcc.IBikeSpdCadAsyncScanResultReceiver scanResultReceiver = new AntPlusBikeSpdCadCommonPcc.IBikeSpdCadAsyncScanResultReceiver() {
        @Override
        ...
        public void onSearchResult(AntPlusBikeSpdCadCommonPcc.BikeSpdCadAsyncScanResultDeviceInfo deviceInfo){
            Log.v(TAG, deviceInfo.resultInfo.getDeviceDisplayName());
            Log.v(TAG, "Device number: " + deviceInfo.resultInfo.getAntDeviceNumber());
            bsdReleaseHandle = mAsyncScanController.requestDeviceAccess(deviceInfo.resultInfo, mResultReceiver, mDeviceStateChangeReceiver);
//                mAsyncScanController.closeScanController();
    ...
    public void resetPcc2() {
        ...
        mAsyncScanController = AntPlusBikeSpeedDistancePcc.requestAsyncScanController(cont, 0, scanResultReceiver);
    }
